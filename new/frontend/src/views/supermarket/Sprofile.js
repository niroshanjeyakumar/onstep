            ...
            <div>
                ...
                <div class="mymenu">
                    <div class="col-md-6"><br></br><nav class="bg-primary navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse"><ul class="navbar-nav">
                                    <li class="nav-item"><a href="#pablo" class="nav-link"><p>Add Offers</p></a></li>
                                    <li class="nav-item"><a href="#pablo" class="nav-link"><p>Add Products</p></a></li>
