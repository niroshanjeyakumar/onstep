...
class editdelp extends React.Component {
  constructor() {
    ...
    componentDidMount() {
    this.setState({
      delivery_name: this.props.expense._id,
      ...
      return (
        <div>
          ...
          <Modal
            ...
            className="Modal"><Link to={{pathname: '/', search: '' }} style={{ textDecoration: 'none' }}>
          ...
          </fieldset><div className='button-center'>
              <br/>
      ...
      return (
        <div>
         ...
         <Modal
           ...
           onRequestClose={this.closeModal}
           contentLabel="Add Expense"
           className="Modal"><div className='button-center'>
